...
<head>
    ...
    <style>
        ...
        .logo {
            ...
            margin-bottom: 5px; /* Espacement entre le logo et le titre */
        }
    </style>
</head>
<body>
    ...
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
        ...
        <div class="w3-container" style="margin-top:80px" id="accueil">
            <h1 class="w3-xxxlarge w3-text-brown"><b>Bienvenue chez Terroirs et Saveurs</b></h1>
        ...
        <div class="w3-container" id="produits" style="margin-top:75px">
            <h1 class="w3-xxxlarge w3-text-brown"><b>Nos Produits</b></h1>
            <hr style="width:50px;border:5px solid brown" class="w3-round">
        ...
        <div class="w3-container" id="nous-sommes" style="margin-top:75px">
            <h1 class="w3-xxxlarge w3-text-brown"><b>Qui Nous Sommes</b></h1>
            <hr style="width:50px;border:5px solid brown" class="w3-round">
